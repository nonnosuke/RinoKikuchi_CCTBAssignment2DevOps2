    ...
    stages {
        ...
        stage('Deploy to Production') {
            ...
            steps {
                ...
                sh """
                ssh -i ~/.ssh/jenkins_controller -o StrictHostKeyChecking=no ec2-user@$PRODUCTION_SERVER 'sudo rm -rf /var/www/html/*'
                ssh -i ~/.ssh/jenkins_controller -o StrictHostKeyChecking=no ec2-user@$PRODUCTION_SERVER "git clone $REPO_URL /var/www/html"
                """
            }
        }
    }
