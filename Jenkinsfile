pipeline {
    ...
    environment {
        ...
        TESTING_SERVER = '54.161.3.212'
        PRODUCTION_SERVER = '54.161.3.212'
    }
    ...
    stages {
        ...
        stage('Deploy to Production') {
            ...
            steps {
                ...
                sh """
                ssh -i /home/ec2-user/keys/Jenkins_Controller.pem -o StrictHostKeyChecking=no ec2-user@$PRODUCTION_SERVER "sudo rm -rf /var/www/html/*"
                ssh -i /home/ec2-user/keys/Jenkins_Controller.pem -o StrictHostKeyChecking=no ec2-user@$PRODUCTION_SERVER "git clone $REPO_URL /var/www/html"
                """
            }
        }
    }
