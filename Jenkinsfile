pipeline {
    ...
    environment {
        ...
        TESTING_SERVER = '54.221.14.161'
        PRODUCTION_SERVER = '54.221.14.161'
    }
    ...
    stages {
        ...
        stage('Deploy to Production') {
            ...
            steps {
                ...
                sh """
                ssh -i /var/lib/jenkins/.ssh/ -o StrictHostKeyChecking=no ec2-user@$PRODUCTION_SERVER 'sudo rm -rf /var/www/html/*'
                ssh -i /var/lib/jenkins/.ssh/ -o StrictHostKeyChecking=no ec2-user@$PRODUCTION_SERVER `git clone $REPO_URL /var/www/html`
                """
            }
        }
    }
